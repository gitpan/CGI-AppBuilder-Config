...
DISTNAME = CGI-AppBuilder-Config-0.12.tar.gz
DISTVNAME = CGI-AppBuilder-Config-0.12.tar.gz-0.12
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         CGI-AppBuilder-Config-0.12.tar.gz' >> META.yml
